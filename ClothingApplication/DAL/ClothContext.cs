    ...
    internal class ClothContext : DbContext
    {
        ...
        private class ClothContextInitializer : DropCreateDatabaseIfModelChanges<ClothContext>
        {
            protected override void Seed(ClothContext context)
            {
                ...
                context.Pants.Add(new Pants { _brand = getBrands.ElementAt(0), _color = "Grey", _fabric = "Denim", _image = null, _inventory = 40, _price = 799, _size = "Medium", _waistSize = 38 });
                context.Jacket.Add(new Jacket { _brand = getBrands.ElementAt(1), _color = "Black", _fabric = "Leather", _image = null, _inventory = 30, _price = 1100, _size = "Medium", _hasHood = false });
                context.Jacket.Add(new Jacket { _brand = getBrands.ElementAt(2), _color = "Beige", _fabric = "Denim", _image = null, _inventory = 30, _price = 900, _size = "Medium", _hasHood = true });
